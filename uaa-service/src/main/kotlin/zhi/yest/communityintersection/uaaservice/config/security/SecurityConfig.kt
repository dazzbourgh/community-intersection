...
import zhi.yest.communityintersection.uaaservice.config.security.dto.VkResponse
import zhi.yest.communityintersection.uaaservice.config.security.dto.VkUserInfo
...
class SecurityConfig {
    ...
    fun authManager(vkCodeTokenResponseClient: VkCodeTokenResponseClient,
        ...
        return OAuth2LoginReactiveAuthenticationManager(vkCodeTokenResponseClient, ReactiveOAuth2UserService { oAuth2UserRequest ->
            WebClient.create().get()
                    ...
                    .map {
                        DefaultOAuth2User(
                                mutableListOf<GrantedAuthority>(OAuth2UserAuthority(mutableMapOf("some" to "attribute" as Any))),
    ...
    fun corsFilter(): CorsWebFilter {
        ...
        corsConfig.allowedOrigins = listOf("http://allowed-origin.com")
